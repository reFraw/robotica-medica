...
startConfig = [2.2738 0.1837 -0.3007 1.3661 0.0583 1.1910 5.7329]';
...
hold on
DrawRobot(DH)
p1 = plot3(xe(1,:), xe(2,:), xe(3,:), LineWidth=3, DisplayName="Traiettoria");
p2 = plot3(startPoint(1), startPoint(2), startPoint(3), Marker="o", MarkerSize=15, MarkerFaceColor="g", DisplayName="Start point");
p3 = plot3(endPoint(1), endPoint(2), endPoint(3), Marker="o", MarkerSize=15, MarkerFaceColor="r", DisplayName="Set point");
realplot = [p1 p2 p3];
