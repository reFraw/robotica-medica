...
startConfiguration = load("OUTPUT_FILE\jointConfigurtion_MAIN02.mat");
...
finalTime = 3;
cruiseVelocityPos = 0.15;
cruiseVelocityOri = 0.9;
...
for i = 1 : nPoints
    ...
    [s, ds, dds] = trapezoidal( ...
        0, normPath, finalTime, cruiseVelocityPos, currentTime);

    desiredPos = c + Rc*[rho*cos(s/rho) rho*sin(s/rho) 0]';

    % Pianificazione dell'orientamento
    [th , dth, ddth] = trapezoidal( ...
        0, thetaFin, finalTime, cruiseVelocityOri, currentTime);
